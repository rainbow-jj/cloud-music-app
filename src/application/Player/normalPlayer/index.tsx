...
import { NormalPlayerContainer, Header, Middle, Footer, CDWrapper, Operators, ProgressWrapper, LyricContainer, LyricWrapper, List, ListItem } from './style';
            ...
            <span>快速听歌</span>
            {
              list.map((item) => {
                return (
                  <ListItem
                    key={item.key}
                    className={`${speed === item.ley ? 'selected': ''}`}
